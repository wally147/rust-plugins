...
namespace Oxide.Plugins
{
    ...
    public class TopOnline : RustPlugin
    {
        ...
        {
            [JsonProperty("MySQL Host")] public string Host = "127.0.0.1";
            [JsonProperty("MySQL Port")] public int Port = 3306;
            [JsonProperty("MySQL Database")] public string Database = "db????";
            [JsonProperty("MySQL Username")] public string Username = "username??";
            [JsonProperty("MySQL Password")] public string Password = "password???";
